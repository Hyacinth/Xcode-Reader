...
NSString *const kSearchManagerTokenResultsKey = @"SearchManagerTokenResultsKey";
NSString *const kSearchManagerNodeResultsKey = @"SearchManagerNodeResultsKey";
NSString *const kSearchManagerCellDatasForTokenKey = @"SearchManagerCellDatasForTokenKey";
NSString *const kSearchManagerCellDatasForNodeKey = @"SearchManagerCellDatasForNodeKey";
...
- (void)prepareSearch
{
    ...
    [self.searchQueue addOperationWithBlock:^{
        ...
        for (SLibrary *library in [[SLibraryManager share] libraries]) {
            NSPersistentStore *affectedStore = [[[SLibraryManager share] coordinator] persistentStoreForURL:library.storeURL];
